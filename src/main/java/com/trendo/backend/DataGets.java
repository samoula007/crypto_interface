...
public class DataGets {
	...
	public DataGets() throws Exception {
		...
		// this.ethMarketCapPercentage =
		// CurrenciesPrice.getMarketCapPercentage(DataBase.uuidETH);
		// this.dogeMarketCapPercentage =
		// CurrenciesPrice.getMarketCapPercentage(DataBase.uuidDOGE);
		// this.bnbMarketCapPercentage =
		// CurrenciesPrice.getMarketCapPercentage(DataBase.uuidBNB);
		// this.linkMarketCapPercentage =
		// CurrenciesPrice.getMarketCapPercentage(DataBase.uuidLINK);
		// this.eosMarketCapPercentage =
		// CurrenciesPrice.getMarketCapPercentage(DataBase.uuidEOS);
		// // total market cap + %
		// this.ethTotalMarketCap = CurrenciesPrice.getTotalMarketCap(DataBase.uuidETH);
		// this.dogeTotalMarketCap =
		// CurrenciesPrice.getTotalMarketCap(DataBase.uuidDOGE);
		// this.bnbTotalMarketCap = CurrenciesPrice.getTotalMarketCap(DataBase.uuidBNB);
		// this.linkTotalMarketCap =
		// CurrenciesPrice.getTotalMarketCap(DataBase.uuidLINK);
		// this.eosTotalMarketCap = CurrenciesPrice.getTotalMarketCap(DataBase.uuidEOS);
		// this.ethTotalMarketCapPercentage =
		// CurrenciesPrice.getTotalMarketCapPercentage(DataBase.uuidETH);
		// this.dogeTotalMarketCapPercentage =
		// CurrenciesPrice.getTotalMarketCapPercentage(DataBase.uuidDOGE);
		// this.bnbTotalMarketCapPercentage =
		// CurrenciesPrice.getTotalMarketCapPercentage(DataBase.uuidBNB);
		// this.linkTotalMarketCapPercentage =
		// CurrenciesPrice.getTotalMarketCapPercentage(DataBase.uuidLINK);
		// this.eosTotalMarketCapPercentage =
		// CurrenciesPrice.getTotalMarketCapPercentage(DataBase.uuidEOS);
		// // volume + %
		...
		// this.ethVolumePercentage =
		// CurrenciesPrice.getVolumePercentage(DataBase.uuidETH);
		// this.dogeVolumePercentage =
		// CurrenciesPrice.getVolumePercentage(DataBase.uuidDOGE);
		// this.bnbVolumePercentage =
		// CurrenciesPrice.getVolumePercentage(DataBase.uuidBNB);
		// this.linkVolumePercentage =
		// CurrenciesPrice.getVolumePercentage(DataBase.uuidLINK);
		// this.eosVolumePercentage =
		// CurrenciesPrice.getVolumePercentage(DataBase.uuidEOS);
